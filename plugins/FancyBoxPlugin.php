...
register_plugin(
		$thisfile, 'FancyBox Plugin', '1.1', 'Patrick Rehder', 'http://www.lippo-design.de/', 'makes FancyBox available on front', 'theme', 'fancybox_plugin_show'
);
...
register_script('FancyBoxConfig', $SITEURL . 'plugins/FancyBoxPlugin/js/FancyBoxConfig.js', '1.1', FALSE);
